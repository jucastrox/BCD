...
SELECT categoria, Count(estoque) AS Contagem 
FROM tb_produto
Group by categoria;
...
/*12. Crie uma VIEW chamada "vw_produtos_lucro" que exibe o nome do produto, categoria e o lucro bruto
 ...
 SELECT nome_produto, categoria, preco_venda, preco_compra,
...
/*14. Usando a view "vw_clientes_aniversariantes", selecione os nomes dos clientes que fazem aniversário em um mês
 ímpar e ordene pelo mês de nascimento. Utilize uma condição para exibir o mês por extenso (ex: 'Janeiro', 'Março', etc.).*/
SELECT nome_cliente 
